  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 font-mono text-sm text-gray-300 bg-black border border-gray-800 p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
        ...
        <section>
          <h2 className="text-lg text-white font-bold uppercase mb-2 border-l-4 border-neon-green pl-3">2. Sales Reporting Protocol</h2>
          <p className="leading-relaxed">
            ...
            <br/>
            <strong>B. CSV Import:</strong> The Platform provides a CSV upload tool for bulk import of sales data from your e-commerce provider.
            <br/>
            <strong>C. Integrity:</strong> Failure to report valid sales is a violation of this protocol and may result in a permanent ban and blacklisting of the Business Entity.
          </p>
        </section>
